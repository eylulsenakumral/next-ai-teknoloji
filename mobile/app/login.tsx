...
const styles = StyleSheet.create({
  ...
  logoLetter: { color: "#ffffff", fontSize: 18, fontWeight: "800" },
  brandTitle: { color: "#0e121a", fontSize: 14, fontWeight: "800" },
  ...
  content: { flex: 1, justifyContent: "center", paddingHorizontal: 28, paddingBottom: 24 },
  formWrap: { width: "100%", maxWidth: 390, alignSelf: "center" },
  ...
  optionText: { color: "#374151", fontSize: 12 },
  primaryLink: { color: COLORS.primary, fontSize: 12, fontWeight: "600" },
  button: {
    height: 50,
    backgroundColor: COLORS.primary,
    alignItems: "center",
  ...
  applyText: { color: COLORS.primary, fontSize: 12, fontWeight: "600" },
  footer: { color: "#9ca3af", fontSize: 12, textAlign: "center", paddingHorizontal: 24, paddingBottom: 18 },
})
