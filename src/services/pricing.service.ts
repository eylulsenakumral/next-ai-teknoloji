...
export interface PriceCalculation {
  ...
  currency: string
  // manualPrice (outlet) ürünlerde, manualPrice uygulanmadan önceki normal hesaplanmış
  // fiyat. outlet olmayan ürünlerde null. Liste UI'ında üzeri çizili orijinal fiyat için.
