            ...
            {subscribed ? (
              ...
              >
                <input
                  ...
                  required
                  className="h-11 w-full sm:w-64 px-4 text-[13px] text-[#333333] bg-white border-0 focus:outline-none focus:ring-0 rounded-l"
                  aria-label="E-posta adresi"
                />
                <button
                  type="submit"
                  className="h-11 px-5 bg-[#333333] hover:bg-[#1a1a1a] text-white text-[12px] font-bold uppercase tracking-wider transition-colors rounded-r shrink-0"
                >
                  Abone Ol
                </button>
              </form>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-extrabold text-[15px] text-[#333333] uppercase tracking-tight">
                Next AI Teknoloji
              </span>
            </div>
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-[13px] text-[#767676] leading-relaxed">
                  Esentepe Mh. Sancad Cad. Real Tower Plaza K:2 D:14 Çorlu/Tekirdağ
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Phone className="h-4 w-4 text-[#00179e] shrink-0 mt-0.5" aria-hidden />
                <div className="space-y-1">
                  <div>
                    <span className="text-[11px] font-semibold text-[#333] uppercase tracking-wide">Satış Destek Hattı</span>
                    <br />
                    <a href="tel:+905529895959" className="text-[13px] text-[#767676] hover:text-[#00179e] transition-colors">
                      0 552 989 5959
                    </a>
                  </div>
                  <div>
                    <span className="text-[11px] font-semibold text-[#333] uppercase tracking-wide">Teknik Destek Hattı</span>
                    <br />
                    <a href="tel:+905529915959" className="text-[13px] text-[#767676] hover:text-[#00179e] transition-colors">
                      0 552 991 5959
                    </a>
                  </div>
                </div>
          ...
          {/* Bilgi */}
          <div>
            <h3 className="font-bold text-[14px] text-[#333333] uppercase tracking-wider mb-4 pb-2 border-b border-[#eeeeee]">
              Bilgi
            </h3>
            <ul className="space-y-2.5">
              {infoLinks.map(({ href, label }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-[14px] text-[#767676] hover:text-[#00179e] transition-colors"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-4">
            ...
            <div className="flex items-center gap-2" aria-label="Güvenli ödeme yöntemleri">
              ...
              <div className="flex items-center gap-1.5 h-8 px-3 border border-[#eeeeee] rounded bg-white">
                ...
                <span className="text-[11px] font-bold text-green-700">SSL</span>
              </div>
              {/* Mastercard */}
              <div className="flex items-center h-8 px-3 border border-[#eeeeee] rounded bg-white">
              ...
              {/* VISA */}
              <div className="flex items-center h-8 px-3 border border-[#eeeeee] rounded bg-white">
                <span className="text-[14px] font-extrabold italic text-[#1A1F71] tracking-tight">VISA</span>
              </div>
              {/* TROY */}
              <div className="flex items-center h-8 px-3 border border-[#eeeeee] rounded bg-white">
