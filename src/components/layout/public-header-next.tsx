...
export function PublicHeaderNext() {
  ...
  const headerClass = cn(
    ...
    home
      ? "border-white/10 bg-[#453e71]/90 text-white"
      : "border-slate-200 bg-white/95 text-[#453e71]"
  )
    ...
    <header className={headerClass}>
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/teklif-iste"
            className="rounded-lg bg-[#ff9b43] px-3 py-2 text-xs font-bold leading-5 text-[#453e71] transition hover:bg-[#ffad64] md:px-4"
          >
            Teklif İste
          </Link>
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : home
                      ...
                      : "text-[#453e71]/80 hover:bg-slate-100"
                )}
              >
                {label}
              </Link>
