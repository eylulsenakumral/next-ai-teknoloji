  ...
  return (
    <article className="group relative flex flex-col bg-white">
      ...
      <div className="flex flex-col gap-1 pt-2.5 pb-1 px-0.5">
        ...
        {/* Fiyat yok — giriş çağrısı */}
        <Link
          href="/login"
          className="mt-1 inline-flex items-center justify-center gap-1 rounded-lg border border-[#00179e]/30 bg-[#00179e]/5 px-2 py-1 text-[11px] font-medium text-[#00179e] hover:bg-[#00179e]/10 transition-colors"
        >
