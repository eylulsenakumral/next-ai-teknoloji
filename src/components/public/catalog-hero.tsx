      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-2xl">
          ...
          <SearchAutocomplete
            ...
            boxClassName="flex h-14 bg-[var(--color-background)] border border-[var(--color-border)] overflow-hidden focus-within:border-nx-accent focus-within:ring-4 focus-within:ring-[var(--color-background)]/50 transition-all rounded-l-[20px] rounded-r-lg"
            inputClassName="flex-1 px-6 text-[15px] text-[var(--color-primary)] placeholder:text-slate-400 focus:outline-none bg-transparent"
            onSubmit={onSearch}
            action={
              <button
                type="submit"
        ...
        <div className="hidden lg:grid grid-cols-3 gap-5 mt-12 pt-8 border-t border-[var(--color-border)]">
          <div className="group relative overflow-hidden rounded-2xl border border-[var(--color-border)] bg-white p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-nx-accent/30">
            ...
            <div className="relative flex items-center gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--color-primary)] to-[#06B6D4] text-white shadow-md transition-transform duration-300 group-hover:scale-110">
                <Shield className="h-6 w-6" aria-hidden />
              </div>
              <div>
                <p className="text-base font-bold text-[var(--color-primary)]">2 Yıl Garanti</p>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-[var(--color-border)] bg-white p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-nx-accent/30">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                <p className="text-base font-bold text-[var(--color-primary)]">Hızlı Teslimat</p>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-[var(--color-border)] bg-white p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-nx-accent/30">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                <p className="text-base font-bold text-[var(--color-primary)]">7/24 Destek</p>
