  ...
  return (
    <section className={`py-16 bg-white ${className}`}>
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-2xl font-bold mb-12 text-[var(--color-primary)]">Öne Çıkan Markalar</h2>
          ...
          {brands.map((brand) => (
            ...
            >
              {brand.logo ? (
                ...
                <span className="text-sm font-semibold text-[var(--color-primary)]">{brand.name}</span>
              )}
            </Link>
          ))}
        </div>
