  ...
  return (
    <div className="relative w-full max-w-[540px] select-none">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#002a6b] shadow-[0_32px_80px_rgba(0,0,0,.6)]">
        <div className="flex items-center justify-between border-b border-white/8 bg-[#003080] px-4 py-3">
        ...
        <div className="grid grid-cols-3 divide-x divide-white/8 border-t border-white/8 bg-[#003080]">
          {[
      ...
      {/* floating alert card */}
      <div className="absolute -right-4 top-8 flex items-center gap-2.5 rounded-xl border border-white/10 bg-[#003080]/90 px-3.5 py-2.5 backdrop-blur-xl shadow-lg">
      ...
      <div className="absolute -left-4 bottom-12 flex items-center gap-2 rounded-xl border border-white/10 bg-[#003080]/90 px-3 py-2 backdrop-blur-xl shadow-lg">
        <div className="flex -space-x-1">
          {["D", "H", "U"].map((l, i) => (
            <div
              key={l}
              className="flex h-6 w-6 items-center justify-center rounded-full border border-[#0040a4] bg-[#5086a8] font-nx-mono text-[9px] font-bold text-white"
              style={{ zIndex: 3 - i }}
            >
              {l}
            </div>
...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-[#0040a4] px-6 pb-0 pt-32 text-white md:px-10 md:pt-40 font-nx-sans">
      {/* bg gradients */}
      <div
        className="pointer-events-none absolute inset-0 -z-10"
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 60% 20%, #5086a818 0%, transparent 70%), linear-gradient(180deg,#0040a4 60%,#002a6b)",
        }}
      />
      <div
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-20 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/8 bg-white/5 sm:grid-cols-4">
          {stats.map(([val, label]) => (
            <div key={label} className="bg-[#0040a4]/60 px-6 py-5 backdrop-blur">
