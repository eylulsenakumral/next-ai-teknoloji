      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#f4f7fa] rounded-lg p-12">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-3xl font-bold text-[#0040a4] mb-2">Bültenimize Abone Olun</h2>
            ...
            <div className="flex flex-col gap-3 w-full md:w-auto">
              <form onSubmit={handleSubmit} className="flex gap-2">
                ...
                <input
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-300 text-[#0040a4] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0040a4]"
                  required
                />
                <button
                  type="submit"
