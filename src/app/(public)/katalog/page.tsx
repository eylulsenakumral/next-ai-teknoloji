    ...
    <section className="relative bg-white border-b border-[#e2e8f0] overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-[#453e71] mb-4">
          ...
          <form onSubmit={handleSubmit} className="flex max-w-xl" role="search" aria-label="Ürün ara">
            <div className="flex flex-1 h-14 bg-[#f4f7fa] border border-[#e2e8f0] overflow-hidden focus-within:border-[#999] focus-within:ring-4 focus-within:ring-[#f4f7fa]/50 transition-all rounded-l-[20px] rounded-r-lg">
              <input
                ...
                className="flex-1 px-6 text-[15px] text-[#453e71] placeholder:text-[#999] focus:outline-none bg-transparent"
                aria-label="Arama terimi"
              />
              <button
                type="submit"
                className="h-full px-8 bg-[#5086a8] hover:bg-[#36305a] text-white font-semibold text-[13px] uppercase tracking-wider transition-colors rounded-r-[20px] flex items-center gap-2"
              >
        ...
        <div className="hidden lg:flex items-center gap-8 mt-12 pt-8 border-t border-[#e2e8f0]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#f4f7fa] flex items-center justify-center">
              <Shield className="h-5 w-5 text-[#453e71]" aria-hidden />
            </div>
            <div>
              <p className="text-sm font-semibold text-[#453e71]">2 Yıl Garanti</p>
              <p className="text-xs text-[#64748b]">Tüm ürünlerde</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#f4f7fa] flex items-center justify-center">
              <Truck className="h-5 w-5 text-[#453e71]" aria-hidden />
            </div>
            <div>
              <p className="text-sm font-semibold text-[#453e71]">Hızlı Teslimat</p>
              <p className="text-xs text-[#64748b]">24-48 saat içinde</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#f4f7fa] flex items-center justify-center">
              <Headphones className="h-5 w-5 text-[#453e71]" aria-hidden />
            </div>
            <div>
              <p className="text-sm font-semibold text-[#453e71]">7/24 Destek</p>
    ...
    <section className="bg-white border-b border-[#e2e8f0]">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/kategoriler"
            className="text-sm font-semibold text-[#5086a8] hover:text-[#36305a] transition-colors flex items-center gap-1 group"
          >
            Tümünü Gör
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center gap-5">
      ...
      <div className="space-y-2">
        <p className="font-semibold text-xl text-[#453e71]">Ürün Bulunamadı</p>
      ...
      <button
        type="button"
        onClick={onClear}
        className="inline-flex items-center gap-2 h-11 px-6 bg-[#5086a8] text-white text-sm font-medium hover:bg-[#36305a] transition-colors rounded-lg"
      >
        Filtreleri Temizle
      </button>
    </div>
...
function MobileFilterSheet({
  ...
  return (
    <>
      <div
        className="fixed inset-0 z-40 bg-[#453e71]/50 backdrop-blur-sm"
        onClick={onClose}
        aria-hidden
      />
      <div
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#e2e8f0]">
          <p className="font-semibold text-base text-[#453e71]">Filtreler</p>
          <button
            type="button"
            onClick={onClose}
            className="p-2 text-[#999] hover:text-[#453e71] hover:bg-[#f4f7fa] rounded-lg transition-colors"
        ...
        <div className="p-4 border-t border-[#e2e8f0]">
          <button
            type="button"
            onClick={onClose}
            className="w-full h-12 bg-[#5086a8] text-white font-medium text-sm rounded-lg hover:bg-[#36305a] transition-colors"
          >
            Filtreleri Uygula
          </button>
        </div>
      ...
      <div className="flex items-center justify-between">
        ...
        {filters.categorySlug || filters.brandSlug || filters.search ? (
          <button
            ...
            className="text-xs font-medium text-[#64748b] hover:text-[#453e71] transition-colors"
          >
            Temizle
          </button>
        ) : null}
        ...
        <div className="space-y-3">
          ...
          {filteredBrands.length > 8 && (
            <button
              ...
              className="flex items-center gap-1 text-xs font-medium text-[#64748b] hover:text-[#453e71] transition-colors"
            >
    ...
    <div className="flex items-center gap-3 flex-wrap">
      <span className="text-sm text-[#64748b]">
        {isLoading ? (
          ...
          <>
            <span className="font-semibold text-[#453e71]">{total.toLocaleString("tr-TR")}</span> ürün
          </>
        )}
      </span>
