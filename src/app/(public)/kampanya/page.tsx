...
function CampaignCard({ campaign }: { campaign: CampaignSet }) {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="p-5">
        <h3 className="text-base font-bold text-[#0040a4] group-hover:text-[#5086a8] transition-colors leading-snug mb-2">
          {campaign.name}
        </h3>
      ...
      <div className="bg-[#f4f7fa] border-b border-[#e2e8f0]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <nav className="flex items-center gap-2 text-[12px] text-[#64748b] mb-4">
            ...
            <span className="text-[#0040a4] font-semibold">Kampanyalar</span>
          </nav>
          <h1 className="text-[32px] font-bold text-[#0040a4] leading-tight">
            Kampanyalar
          </h1>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {campaigns.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center gap-4 border-2 border-dashed border-gray-300 rounded-[20px] bg-[#f4f7fa]/50">
            ...
            <Link
              href="/katalog"
              className="inline-flex items-center gap-2 bg-[#5086a8] text-white font-bold px-6 py-2.5 rounded-lg hover:bg-[#0040a4] transition-colors text-sm"
            >
              Kataloga Git
            </Link>
          </div>
