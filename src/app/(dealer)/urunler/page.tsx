        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          >
            ...
            {filters.q && (
              <>
                <ChevronRight className="h-3 w-3 text-[#eeeeee]" aria-hidden />
                <span className="text-[#00179e] font-semibold">&ldquo;{filters.q}&rdquo;</span>
              </>
            )}
          </nav>
          ...
          <div className="flex-1 min-w-0 space-y-4">
            ...
            <div className="flex items-center gap-3 flex-wrap bg-white border border-[#eeeeee] px-4 py-2.5">
              ...
              <button
                ...
                className="lg:hidden inline-flex items-center gap-2 h-8 px-3 border border-[#eeeeee] text-[12px] font-semibold text-[#333333] hover:border-[#00179e] hover:text-[#00179e] transition-colors"
            ...
            {!isLoadingProducts && totalPages > 1 && (
              ...
              >
                <button
                  ...
                  className="inline-flex items-center justify-center h-9 w-9 border border-[#eeeeee] text-[#767676] hover:border-[#00179e] hover:text-[#00179e] disabled:opacity-40 disabled:cursor-not-allowed transition-colors bg-white"
                >
