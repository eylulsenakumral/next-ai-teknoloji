...
const PUBLIC_API_PATHS = ["/api/auth", "/api/public", "/api/cron", "/api/chat", "/api/exchange-rate", "/api/indexgrup/sync", "/api/netex/sync", "/api/tesan/sync", "/api/payment", "/api/locations", "/api/categories"]
